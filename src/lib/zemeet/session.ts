...
function getDemoZeMeetSession(
  ...
  return {
    context: {
      ...
      candidateName: "Aaran Sharma",
      interviewId: "i-demo",
      candidateIntel: {
        email: "aaran.sharma@email.com",
        experience: "5 years · Frontend Engineering · SaaS",
        education: "B.Tech Computer Science — IIT Delhi",
        skills: ["React", "TypeScript", "System Design", "Node.js"],
        portfolioUrl: "https://aaransharma.dev",
        linkedin: "linkedin.com/in/aaransharma",
        resumeUrl: "/resumes/aaran-sharma.pdf",
