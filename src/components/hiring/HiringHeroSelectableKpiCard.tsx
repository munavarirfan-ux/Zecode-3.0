...
export function HiringHeroSelectableKpiCard({
  label,
  value,
  subtitle,
  icon: Icon,
    ...
    <li>
      <button
        ...
        className={cn(
          ...
          active &&
            "border-white/[0.38] bg-white/[0.2] shadow-[inset_0_1px_0_rgba(255,255,255,0.28),0_0_0_1px_rgba(255,255,255,0.2),0_12px_40px_-10px_rgba(0,0,0,0.35)]",
        )}
      >
        <div
        ...
        <p className="relative mt-0.5 line-clamp-2 text-[10px] leading-snug text-white/55">{subtitle}</p>
      </button>
    </li>
  );
}
